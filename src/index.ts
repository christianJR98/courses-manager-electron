...
ipcMain.handle(ACTIONS.ADD_COURSE, addCourse);
ipcMain.handle(ACTIONS.GET_COURSES, getCourses);
ipcMain.handle(ACTIONS.SEARCH_COURSES, searchCourses);
